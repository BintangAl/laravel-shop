                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="border border-1 rounded mb-4">
                        <div class="input-group input-group-lg border-bottom">
                            <span class="input-group-text text-gray bg-white border-0" id="span" style="border-radius: 0; border-top-left-radius: 10px;"><i class="bi bi-person"></i></span>
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white border-0 shadow-none overpass" id="name" name="name" value="{{ old('name') }}" placeholder="name">
                                <label for="name" class="text-gray">Name</label>
                            </div>
                        </div>
                        <div class="input-group input-group-lg border-bottom">
                            <span class="input-group-text text-gray bg-white border-0" id="span" style="border-radius: 0; border-top-left-radius: 10px;"><i class="bi bi-envelope"></i></span>
                            <div class="form-floating">
                                <input type="email" class="form-control bg-white border-0 shadow-none overpass" id="email" name="email" value="{{ old('email') }}" placeholder="Email address">
                        ...
                        <div class="input-group input-group-lg">
                            <span class="input-group-text text-gray bg-white border-0" style="border-radius: 0; border-bottom-left-radius: 10px"><i class="bi bi-lock-fill"></i></span>
                            <div class="form-floating">
                                <input type="password" class="form-control bg-white border-0 shadow-none overpass" id="password_confirmation" name="password_confirmation" placeholder="Password Confirmation">
                    ...
                    <div class="d-lg-flex d-block px-2 px-lg-0 mb-4">
                        <button class="col-lg-auto col-12 mb-3 mb-lg-0 btn bg-main shadow-sm text-light px-4 py-2 me-3 rounded-pill fs-small" onclick="$('#load').show();">Create Account</button>
                        <a href="{{ route('login') }}" class="col-lg-auto col-12 mb-3 mb-lg-0 btn bg-white shadow-sm px-4 py-2 border-0 rounded-pill fs-small">Login</a>
                    </div>
                </form>
