<div class="container mt-4 overpass select-none">
    ...
    <div class="col-12 mb-3 position-relative">
        <div class="arrow arrow-left bg-white rounded-circle text-center p-1 d-block d-xl-none"><i
                class="fa-solid fa-angle-left"></i></div>
        <div class="arrow arrow-right bg-white rounded-circle text-center p-1 d-block d-xl-none"><i
            ...
            <div class="d-flex overpass" id="category" style="overflow: auto">
                ...
                @foreach ($category as $item)
                    <div class="w-125 {{ ++$i === $numItems ? '' : 'border-end' }}">
                        <a href="{{ route('category', [$item->id, strtolower(str_replace(' ', '_', $item->category))]) }}"
                            class="box-category">
