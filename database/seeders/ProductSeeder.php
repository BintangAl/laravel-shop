...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            'product_price' => '57500',
            'product_detail' => '
                √ PANJANG BADAN (PB) SIZE M - 65CM

                √ LINGKAR DADA (LD) SIZE M -96CM


                √ PANJANG BADAN (PB) SIZE L - 67CM

                √ LINGKAR DADA (LD) SIZE L - 108CM

                Nama Bahan : Katun Twill 30s


                • Bahan katun twill 30s merupakan bahan yang memiliki tekstur lebih lembut, halus, jatuh, adem dan memiliki daya serap keringat yang kuat (mudah menyerap keringat) 
                • Tenunan kainnya yang rapat membuat bahan tidak menerawang dan tidak mudah robek
                • Dengan banyak varian warna, cocok dipakai sehari-hari, hangout, kerja, maupun kuliah 
        ...
        DB::table('products')->insert([
            ...
            'product_detail' => '
                ...
                Lebar total bingkai （mm） ： 146
                Lebar lensa （mm） ： 65
                Tinggi lensa （mm） ： 58
                Lebar hidung （mm） ： 18
                Panjang kaki cermin （mm） ： 145
