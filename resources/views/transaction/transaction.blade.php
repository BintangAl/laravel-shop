    ...
    <div class="container mt-3 overpass">
        ...
        <div class="bg-white shadow-sm mb-3">
            <div class="p-3 border-bottom">
                ...
                <div class="mb-1">
                    @if ($payment != [])
                        ...
                        <div class="text-gray fs-small">Pembayaran dengan cara transfer ke nomor rekening virtual dari bank
            ...
            <div class="p-3 border-gray-bottom-dash">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="fs-small fw-bold">Rp {{ number_format($product->product_price * $transaction->quantity) }}
                    </div>
                </div>
                <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="fs-small fw-bold">
                        ...
                        @else
                            <span class="text-danger pointer" onclick="window.location.reload(); load()">error-500</span>
                        @endif
                    </div>
                </div>
            </div>
        ...
        @if ($transaction->status == 'Belum Bayar')
            <button class="btn bg-main text-light w-100 mb-3 rounded-0"
                ...
                Pembayaran</button>
            <button class="btn bg-gray w-100 mb-3 rounded-0" onclick="$('.confirm').fadeIn('fast');">Batalkan
                Pesanan</button>
        @endif
        ...
        @if ($transaction->status == 'Dikirim')
            <button class="btn bg-main text-light w-100 mb-3 rounded-0" onclick="$('.confirm').fadeIn('fast');">Konfirmasi
                Pesanan
                Diterima</button>
        @endif
